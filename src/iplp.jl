...
struct IplpSolution
    ...
    cs::Vector # the objective vector in standard form
    As::SparseMatrixCSC # the constraint matrix in standard form
    bs::Vector # the right hand side (b) in standard form
