...
#c = [-8-14η, -12, 0, 0, 0, 0]; 	# converges to (30, 50)
#c = [-8-4η, -12-10η, 0, 0, 0, 0]; 	# converges to (0, 70)
c = [-8-14η, -12-10η, 0, 0, 0, 0]; 	# converges to (30, 50)
#c = [-8, -12-10η, 0, 0, 0, 0]; 	# converges to (0, 70)
b = [120, 210, 270, 60];
...
sol = ipqp(A,b,c,Q, tol; maxit=25, verbose=verbose, genLatex=genLatex, slack_var=3:6);
